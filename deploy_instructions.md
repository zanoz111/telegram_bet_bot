...
Для боевого режима на VPS добавьте в файл только:
```
BOT_TOKEN=ваш_боевой_токен_бота
```
(Не указывайте TEST_MODE — по умолчанию боевой режим: один игрок создаёт, другой выбирает сторону.)
